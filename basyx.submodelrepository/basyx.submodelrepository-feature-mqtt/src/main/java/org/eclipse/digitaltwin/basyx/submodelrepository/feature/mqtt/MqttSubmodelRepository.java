...
public class MqttSubmodelRepository implements SubmodelRepository {
  ...
  private static final Logger logger = LoggerFactory.getLogger(MqttSubmodelRepository.class);
  private final MqttSubmodelRepositoryTopicFactory topicFactory;

  private final SubmodelRepository decorated;

  private final IMqttClient mqttClient;

  public MqttSubmodelRepository(SubmodelRepository decorated, IMqttClient mqttClient,
      MqttSubmodelRepositoryTopicFactory topicFactory) {
  ...
  private void submodelElementCreated(SubmodelElement submodelElement, String repoId, String submodelId,
      String submodelElementId) {
    sendMqttMessage(topicFactory.createCreateSubmodelElementTopic(repoId, submodelId, submodelElementId),
        SubmodelElementSerializer.serializeSubmodelElement(submodelElement));
  }

  private void submodelElementUpdated(SubmodelElement submodelElement, String repoId, String submodelId,
      String submodelElementId) {
    sendMqttMessage(topicFactory.createUpdateSubmodelElementTopic(repoId, submodelId, submodelElementId),
        SubmodelElementSerializer.serializeSubmodelElement(submodelElement));
  }

  private void submodelElementDeleted(SubmodelElement submodelElement, String repoId, String submodelId,
      String submodelElementId) {
    sendMqttMessage(topicFactory.createDeleteSubmodelElementTopic(repoId, submodelId, submodelElementId),
        SubmodelElementSerializer.serializeSubmodelElement(submodelElement));
  }
  ...
  public java.io.File getFileByPathSubmodel(String submodelId, String idShortPath) {
    throw ExceptionBuilderFactory.getInstance().featureNotImplementedException().featureName("getFileByPathSubmodel")
        .build();
  }

  @Override
  public void deleteFileValue(String identifier, String idShortPath) {
    throw ExceptionBuilderFactory.getInstance().featureNotImplementedException().featureName("deleteFileValue")
        .build();
  }

  @Override
  public void setFileValue(String submodelId, String idShortPath, String fileName, InputStream inputStream) {
    throw ExceptionBuilderFactory.getInstance().featureNotImplementedException().featureName("setFileValue")
        .build();
  }
