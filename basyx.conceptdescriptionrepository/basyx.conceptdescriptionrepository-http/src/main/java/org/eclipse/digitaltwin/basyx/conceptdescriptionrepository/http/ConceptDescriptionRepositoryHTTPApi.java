...
public interface ConceptDescriptionRepositoryHTTPApi {
  ...
  @Operation(summary = "Returns a specific Concept Description", description = "",
      tags = {"Concept Description Repository API"})
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Requested Concept Description",
      content = @Content(mediaType = "application/json", schema = @Schema(implementation = ConceptDescription.class))),
  ...
  @Operation(summary = "Creates a new Concept Description", description = "",
      tags = {"Concept Description Repository API"})
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Concept Description created successfully",
      content = @Content(mediaType = "application/json", schema = @Schema(implementation = ConceptDescription.class))),
  ...
  @Operation(summary = "Updates an existing Concept Description", description = "",
      tags = {"Concept Description Repository API"})
