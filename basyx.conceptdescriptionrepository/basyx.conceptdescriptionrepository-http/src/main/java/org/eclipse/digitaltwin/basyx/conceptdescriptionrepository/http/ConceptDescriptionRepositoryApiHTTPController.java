...
@jakarta.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen",
    date = "2023-03-21T12:35:49.719724407Z[GMT]")
@RestController
public class ConceptDescriptionRepositoryApiHTTPController implements ConceptDescriptionRepositoryHTTPApi {
  ...
  public ResponseEntity<PagedResult> getAllConceptDescriptions(@Valid String idShort,
    ...
    CursorResult<List<ConceptDescription>> filteredResult =
        repoFilter.filter(idShort, isCaseOfReference, dataSpecificationReference, pInfo);
