...
public class TestAASEnvironmentSerialization {
  ...
  public void setup() {
    ...
    aasEnvironment =
        new DefaultAASEnvironmentSerialization(aasRepository, submodelRepository, conceptDescriptionRepository);
  }
  ...
  public void testAASEnviromentSerializationWithAASX()
      throws SerializationException, IOException, InvalidOperationException, InvalidFormatException,
  ...
  private void validateRepositoriesState() {
    ...
    assertTrue(
        submodelRepository.getAllSubmodels(NO_LIMIT_PAGINATION_INFO).getResult().containsAll(createDummySubmodels()));
